/**
 * For social media links and other footer content
 */
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            />
                            <span className="text-2xl font-bold text-[#0033A0] tracking-tight">SpartaXchange</span>
                        </div>
                        <p className="text-sm text-gray-600 text-center md:text-left">
                            Your trusted marketplace for SJSU students
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <nav aria-label="Social" className="flex items-center gap-2">
                            ...
                            <Link 
                                href="#" 
                                className="text-gray-600 hover:text-pink-700 transition-colors p-2 rounded-full hover:bg-gray-100"
                ...
                <div className="border-t border-gray-200 pt-6">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-gray-600">
                            © {currentYear} SpartaXchange. All rights reserved.
                        </p>
